...
(defcustom hideshowvis-ignore-same-line t
  "Omit fringe symbol if the matching closing parenthesis is on the same line.
Set this to nil if enabling the minor mode is slow on your machine"
  :type 'boolean
  :group 'hideshow)
...
(defun hideshowvis-click-fringe (event)
  "Toggle the line to show or hide through a mouse EVENT."
  (interactive "e")
...
(defun hideshowvis-symbols ()
  "Defines the things necessary to get symbols and markers in the fringe.
A '+' symbol in the fringe and a yellow marker indicating the number of hidden
lines at the end of the line for hidden regions."
  (interactive)
