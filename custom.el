...
(custom-set-variables
 ...
 '(package-selected-packages
   '(epresent lsp-ui lsp-mode hl-todo projectile auto-package-update which-key with-editor tablist swiper scratch pyvenv lispy pdf-tools iedit highlight-indentation find-file-in-project counsel ace-window transient elpy magit ivy flycheck-clojure flycheck-inline-mode flycheck-mode racer toml-mode cargo flycheck-rust rust-mode vlf clj-refactor-mode clj-refactor cider clojure-mode doom-modeline undo-tree org-bullets org-fancy-priorities paradox spaceline-all-the-icons all-the-icons ac-js2 org-pomodoro diminish xref-js2 js2-refactor js2-mode yaml-mode flycheck-irony company-irony latex-math-preview flycheck-rtags company-rtags htmlize rainbow-delimiters ac-slime highlight-thing diff-hl gitconfig-mode gitignore-mode pip-requirements whitespace-cleanup-mode highlight-escape-sequences flycheck-pos-tip multiple-cursors markdown-mode wrap-region winum ox-reveal neotree flyspell-correct auctex-latexmk atom-one-dark-theme))
 '(sh-basic-offset 4)
 '(sh-indentation 2)
 '(smie-indent-basic 2)
