...
(custom-set-faces
 ...
 '(org-level-3 ((t (:foreground "#61AFEF" :weight bold))))
 '(org-level-4 ((t (:foreground "#E5C07B" :underline (:color foreground-color :style wave)))))
 '(org-todo ((t (:foreground "#E06C75" :weight bold))))
 '(org-upcoming-deadline ((t (:foreground "#BE5046"))))
